...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btnConnectAdbNew = findViewById(R.id.btn_connect_adb_new);
        ...
        btnConnectAdb.setOnClickListener(v -> {
            ...
            startADB(remoteAddr, false);
        });

        btnConnectAdbNew.setOnClickListener(v -> {
            String remoteAddr = etRemoteAddr.getText().toString();
            sharedPreferences.edit().putString("remoteAddr", remoteAddr).apply();
            startADB(remoteAddr, true);
        });
    }
    ...
    private void startADB(String remoteAddr, boolean newUI) {
        if (newUI) {
            // 检测悬浮窗权限
    ...
    private void showFloatWindow() {
        ...
        floatView = LayoutInflater.from(this).inflate(R.layout.activity_view, null);
        runOnUiThread(() -> wm.addView(floatView, layoutParams));

        final SurfaceView displayView = (SurfaceView) floatView.findViewById(R.id.display);
